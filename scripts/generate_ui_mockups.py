...
def create_main_window_mockup():
    ...
    draw.text(
        (50, 435), "A beautiful sunset over the ocean,", fill=(224, 224, 224), font=font_small
    )
    draw.text(
        (50, 450), "waves gently lapping at the shore...", fill=(224, 224, 224), font=font_small
    )
    ...
    for tab_name, active in tabs:
        ...
        if active:
            draw_rounded_rect(
                draw, (x_offset, 30, x_offset + tab_width, 55), 8, (26, 26, 46), (124, 138, 255)
            )
